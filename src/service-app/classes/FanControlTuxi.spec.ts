...
describe('FanControlTuxi', (): void => {
    ...
    it('Sirius Gen 2: hwmon label match', async (): Promise<void> => {
        ...
        tempInputMap.set(1, new SysFsPropertyInteger('/sys/class/hwmon/hwmon4/temp1_input'));
        tempInputMap.set(2, new SysFsPropertyInteger('/sys/class/hwmon/hwmon4/temp2_input'));
        ...
        fanTempMap.set(1, {
            tempLabel: 'cpu0',
            tempInput: new SysFsPropertyInteger('/sys/class/hwmon/hwmon4/temp1_input'),
        });
        fanTempMap.set(2, {
            tempLabel: 'gpu0',
            tempInput: new SysFsPropertyInteger('/sys/class/hwmon/hwmon4/temp2_input'),
        });
    ...
    it('Sirius Gen 2: set map data', async (): Promise<void> => {
        ...
        fanSpeedInputMap.set(1, new SysFsPropertyInteger(`${hwmonPath}/fan1_input`));
        fanSpeedInputMap.set(2, new SysFsPropertyInteger(`${hwmonPath}/fan2_input`));

        const fanMaxInputMap = new Map();
        fanMaxInputMap.set(1, new SysFsPropertyInteger(`${hwmonPath}/fan1_max`));
        fanMaxInputMap.set(2, new SysFsPropertyInteger(`${hwmonPath}/fan2_max`));

        const pwmInputMap = new Map();
        pwmInputMap.set(1, new SysFsPropertyInteger(`${platformPath}/fan1_pwm`));
        pwmInputMap.set(2, new SysFsPropertyInteger(`${platformPath}/fan2_pwm`));
        ...
        tempInputMap.set(1, new SysFsPropertyInteger(`${hwmonPath}/temp1_input`));
        tempInputMap.set(2, new SysFsPropertyInteger(`${hwmonPath}/temp2_input`));
    ...
    it('Sirius Gen 2: get fan speed', async (): Promise<void> => {
        ...
        expect(await fanApi.getFanSpeedPercent(1)).toEqual(Math.round((4000 / 6000) * 100));
    });
