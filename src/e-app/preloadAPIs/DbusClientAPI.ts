...
import { DbusAPIFunctions, dbusAPIHandle } from '../../common/models/IDbusAPI';
...
export const DbusClientAPI = {
    ...
    tuxedoWmiAvailable: (): Promise<boolean> =>
        ipcRenderer.invoke(dbusAPIHandle, [DbusAPIFunctions.tuxedoWmiAvailable]),
    ...
    getForceYUV420OutputSwitchAvailable: (): Promise<boolean> =>
        ipcRenderer.invoke(dbusAPIHandle, [DbusAPIFunctions.getForceYUV420OutputSwitchAvailable]),
    consumeModeReapplyPending: (): Promise<boolean> =>
        ipcRenderer.invoke(dbusAPIHandle, [DbusAPIFunctions.consumeModeReapplyPending]),
    getActiveProfileJSON: (): Promise<string> =>
        ipcRenderer.invoke(dbusAPIHandle, [DbusAPIFunctions.getActiveProfileJSON]),
    setTempProfileById: (profileId: string): Promise<boolean> =>
        ipcRenderer.invoke(dbusAPIHandle, [DbusAPIFunctions.setTempProfileById, profileId]),
    ...
    getCustomProfilesJSON: (): Promise<string> =>
        ipcRenderer.invoke(dbusAPIHandle, [DbusAPIFunctions.getCustomProfilesJSON]),
    getDefaultProfilesJSON: (): Promise<string> =>
        ipcRenderer.invoke(dbusAPIHandle, [DbusAPIFunctions.getDefaultProfilesJSON]),
    getDefaultValuesProfileJSON: (): Promise<string> =>
        ipcRenderer.invoke(dbusAPIHandle, [DbusAPIFunctions.getDefaultValuesProfileJSON]),
    ...
    odmProfilesAvailable: (): Promise<string[]> =>
        ipcRenderer.invoke(dbusAPIHandle, [DbusAPIFunctions.odmProfilesAvailable]),
    ...
    getKeyboardBacklightCapabilitiesJSON: (): Promise<string> =>
        ipcRenderer.invoke(dbusAPIHandle, [DbusAPIFunctions.getKeyboardBacklightCapabilitiesJSON]),
    getKeyboardBacklightStatesJSON: (): Promise<string> =>
        ipcRenderer.invoke(dbusAPIHandle, [DbusAPIFunctions.getKeyboardBacklightStatesJSON]),
    setKeyboardBacklightStatesJSON: (keyboardBacklightStatesJSON: string): Promise<boolean> =>
        ipcRenderer.invoke(dbusAPIHandle, [
            DbusAPIFunctions.setKeyboardBacklightStatesJSON,
    ...
    getFansOffAvailable: (): Promise<boolean> =>
        ipcRenderer.invoke(dbusAPIHandle, [DbusAPIFunctions.getFansOffAvailable]),
    getChargingProfilesAvailable: (): Promise<string[]> =>
        ipcRenderer.invoke(dbusAPIHandle, [DbusAPIFunctions.getChargingProfilesAvailable]),
    getCurrentChargingProfile: (): Promise<string> =>
        ipcRenderer.invoke(dbusAPIHandle, [DbusAPIFunctions.getCurrentChargingProfile]),
    setChargingProfile: (profileDescriptor: string): Promise<boolean> =>
        ipcRenderer.invoke(dbusAPIHandle, [DbusAPIFunctions.setChargingProfile, profileDescriptor]),
    getChargingPrioritiesAvailable: (): Promise<string[]> =>
        ipcRenderer.invoke(dbusAPIHandle, [DbusAPIFunctions.getChargingPrioritiesAvailable]),
    getCurrentChargingPriority: (): Promise<string> =>
        ipcRenderer.invoke(dbusAPIHandle, [DbusAPIFunctions.getCurrentChargingPriority]),
    setChargingPriority: (priorityDescriptor: string): Promise<boolean> =>
        ipcRenderer.invoke(dbusAPIHandle, [DbusAPIFunctions.setChargingPriority, priorityDescriptor]),
    getDGpuInfoValuesJSON: (): Promise<string> =>
        ipcRenderer.invoke(dbusAPIHandle, [DbusAPIFunctions.getDGpuInfoValuesJSON]),
    getIGpuInfoValuesJSON: (): Promise<string> =>
        ipcRenderer.invoke(dbusAPIHandle, [DbusAPIFunctions.getIGpuInfoValuesJSON]),
    getSensorDataCollectionStatus: (): Promise<boolean> =>
        ipcRenderer.invoke(dbusAPIHandle, [DbusAPIFunctions.getSensorDataCollectionStatus]),
    ...
    getCpuPowerValuesJSON: (): Promise<string> =>
        ipcRenderer.invoke(dbusAPIHandle, [DbusAPIFunctions.getCpuPowerValuesJSON]),
    getDisplayModesJSON: (): Promise<string> =>
        ipcRenderer.invoke(dbusAPIHandle, [DbusAPIFunctions.getDisplayModesJSON]),
    ...
    getChargeEndAvailableThresholds: (): Promise<number[]> =>
        ipcRenderer.invoke(dbusAPIHandle, [DbusAPIFunctions.getChargeEndAvailableThresholds]),
    getChargeStartThreshold: (): Promise<number> =>
        ipcRenderer.invoke(dbusAPIHandle, [DbusAPIFunctions.getChargeStartThreshold]),
    getChargeEndThreshold: (): Promise<number> =>
        ipcRenderer.invoke(dbusAPIHandle, [DbusAPIFunctions.getChargeEndThreshold]),
    ...
    setChargeStartThreshold: (newValue: number): Promise<boolean> =>
        ipcRenderer.invoke(dbusAPIHandle, [DbusAPIFunctions.setChargeStartThreshold, newValue]),
    setChargeEndThreshold: (newValue: number): Promise<boolean> =>
        ipcRenderer.invoke(dbusAPIHandle, [DbusAPIFunctions.setChargeEndThreshold, newValue]),
    ...
    getNVIDIAPowerCTRLMaxPowerLimit: (): Promise<number> =>
        ipcRenderer.invoke(dbusAPIHandle, [DbusAPIFunctions.getNVIDIAPowerCTRLMaxPowerLimit]),
    getNVIDIAPowerCTRLAvailable: (): Promise<boolean> =>
        ipcRenderer.invoke(dbusAPIHandle, [DbusAPIFunctions.getNVIDIAPowerCTRLAvailable]),
    getIsUnsupportedConfigurableTGPDevice: (): Promise<boolean> =>
        ipcRenderer.invoke(dbusAPIHandle, [DbusAPIFunctions.getIsUnsupportedConfigurableTGPDevice]),
};
