...
export class TccDBusClientService implements OnDestroy {
    ...
    public fanData: BehaviorSubject<IDBusFanData> = new BehaviorSubject<IDBusFanData>({
        cpu: new FanData(),
        gpu1: new FanData(),
        gpu2: new FanData(),
    });
    ...
    public keyboardBacklightCapabilities: BehaviorSubject<KeyboardBacklightCapabilitiesInterface> =
        new BehaviorSubject<KeyboardBacklightCapabilitiesInterface>(undefined);
    public keyboardBacklightStates: BehaviorSubject<Array<KeyboardBacklightStateInterface>> = new BehaviorSubject<
        Array<KeyboardBacklightStateInterface>
    >(undefined);
    ...
    >([
        ...
        [
            this.primeState,
            {
                ...
                dbusFunction: (): Promise<string> => window.dbusAPI.getPrimeState(),
            },
        ],
        [
            this.iGpuInfo,
            {
                ...
                dbusFunction: (): Promise<string> => window.dbusAPI.getIGpuInfoValuesJSON(),
            },
        ],
        [
            this.dGpuInfo,
            {
                ...
                dbusFunction: (): Promise<string> => window.dbusAPI.getDGpuInfoValuesJSON(),
            },
        ],
        [
            this.cpuPower,
            {
                ...
                dbusFunction: (): Promise<string> => window.dbusAPI.getCpuPowerValuesJSON(),
            },
        ],
        [
            this.displayModes,
            {
                ...
                dbusFunction: (): Promise<string> => window.dbusAPI.getDisplayModesJSON(),
            },
        ],
        [
            this.keyboardBacklightCapabilities,
            {
                ...
                dbusFunction: (): Promise<string> => window.dbusAPI.getKeyboardBacklightCapabilitiesJSON(),
            },
        ],
        [
            this.keyboardBacklightStates,
            {
                ...
                dbusFunction: (): Promise<string> => window.dbusAPI.getKeyboardBacklightStatesJSON(),
            },
        ],
        ...
        [
            this.fansMinSpeed,
            {
                ...
                dbusFunction: (): Promise<number> => window.dbusAPI.getFansMinSpeed(),
            },
        ],
        [
            this.fansOffAvailable,
            {
                ...
                dbusFunction: (): Promise<boolean> => window.dbusAPI.getFansOffAvailable(),
            },
        ],
        ...
        [
            this.nvidiaPowerCTRLDefaultPowerLimit,
            {
                ...
                dbusFunction: (): Promise<number> => window.dbusAPI.getNVIDIAPowerCTRLDefaultPowerLimit(),
            },
        ],
        [
            this.nvidiaPowerCTRLMaxPowerLimit,
            {
                ...
                dbusFunction: (): Promise<number> => window.dbusAPI.getNVIDIAPowerCTRLMaxPowerLimit(),
            },
        ],
        [
            this.nvidiaPowerCTRLAvailable,
            {
                ...
                dbusFunction: (): Promise<boolean> => window.dbusAPI.getNVIDIAPowerCTRLAvailable(),
            },
        ],
        [
            this.isUnsupportedConfigurableTGPDevice,
            {
                ...
                dbusFunction: (): Promise<boolean> => window.dbusAPI.getIsUnsupportedConfigurableTGPDevice(),
            },
        ],
        [
            this.tuxedoWmiAvailable,
            {
                ...
                dbusFunction: (): Promise<boolean> => window.dbusAPI.tuxedoWmiAvailable(),
            },
        ],
        [
            this.fanHwmonAvailable,
            {
                ...
                dbusFunction: (): Promise<boolean> => window.dbusAPI.fanHwmonAvailable(),
            },
        ],
        [
            this.sensorDataCollectionStatus,
            {
                ...
                dbusFunction: (): Promise<boolean> => window.dbusAPI.getSensorDataCollectionStatus(),
            },
        ],
        [
            this.chargingProfilesAvailable,
            {
                ...
                dbusFunction: (): Promise<string[]> => window.dbusAPI.getChargingProfilesAvailable(),
            },
        ],
        [
            this.webcamSWAvailable,
            {
                ...
                dbusFunction: (): Promise<boolean> => window.dbusAPI.webcamSWAvailable(),
            },
        ],
        [
            this.webcamSWStatus,
            {
                ...
                dbusFunction: (): Promise<boolean> => window.dbusAPI.getWebcamSWStatus(),
            },
        ],
        [
            this.forceYUV420OutputSwitchAvailable,
            {
                ...
                dbusFunction: (): Promise<boolean> => window.dbusAPI.getForceYUV420OutputSwitchAvailable(),
            },
        ],
    ]);
    ...
    public async getDbusData(): Promise<void> {
        const promiseArray: Promise<void>[] = Array.from(this.dbusFunctionMap.entries()).map(
            ([behaviorSubject, { dbusFunctionName, dbusFunction }]: [
                BehaviorSubject<any>,
                DbusFunctionEntry,
            ]): Promise<void> => {
                return this.updateBehaviorSubject(behaviorSubject, dbusFunctionName, dbusFunction);
            },
        );
    ...
    public async setTempProfileById(profileId: string): Promise<boolean> {
        const result: boolean =
            (await window.dbusAPI.dbusAvailable()) && (await window.dbusAPI.setTempProfileById(profileId));
        return result;
    }
